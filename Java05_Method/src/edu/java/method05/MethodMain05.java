...
public class MethodMain05 {
	...
	public static void main(String[] args) {
		...
		// printf는 가변 길이 (variable-length) argument를 갖는 메서드.
		// 파라미터를 선언할 때, 변수 타입 뒤에 "..."을 붙임.
		// 가변길이 아규먼트에는 전달하는 값의 갯수는 제한이 없음.아규먼트를 전달하지 않아도 됨.
		// 가변길이 아규먼트는 메서드 안에서는 배열처럼 취급함.
		// (주의) 가변길이 아규먼트는 가장 마지막 파라미터로 선언해야 함!
	 ...
	 * 만약 아규먼트로 전달된 숫자가 없으면 1을 리턴.
	 * op가 "+" 또는 "*"가 아니면 0.0 을 리턴.
	 */
