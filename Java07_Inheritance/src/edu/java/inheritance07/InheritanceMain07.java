...
abstract class Animal { // 객체를 생성할 수 없는 추상클래스
	public abstract void move();  //수식어는 리턴타입(void)앞으로 붙여줘야함~! /
}
...
public class InheritanceMain07 {
	...
	public static void main(String[] args) {
		...
		// 다형성: SuperType var = new SubType object();
