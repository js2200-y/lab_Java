...
public class Student {
	...
	// 생성자
	// (1) 기본 생성자  (2) stuNo, name, score 를 초기화 할 수 있는 생성자
	public Student() {	}
...
//			System.out.println("Java 점수: " + this.score.sql);
//			System.out.println("Java 점수: " + this.score.html);
...
//	public void printStudent() { 
//		System.out.printf("학번: %d, 이름: %s, 세과목점수: %d, %d, %d\n", this.stuNo, this.name, score.java, score.sql, score.html);
//		System.out.printf("총점: %f, 평균: %f", score.getTotal(), score.getAverage());
	}
