...
public class InnerMain03 {
	...
	public static void main(String[] args) {
		...
		class SaveButtonListenner implements OnClickListener {
		...
		// 3. OnclickListenner 타입 객체 생성
		OnClickListener listener2 = new SaveButtonListenner();

		// 4. OnclickListenner를 버튼의 기능으로 설정.
